...
## 🛡️ Якість та безпека коду

Проєкт інтегровано з **SonarQube Cloud** для автоматизованої перевірки якості та
безпеки коду в межах підходу **DevSecOps**. Аналіз запускається автоматично при кожному push.

Поточні показники:
- **Security:** рейтинг A (0 вразливостей)
- **Reliability:** рейтинг C
- **Maintainability:** рейтинг A
- **Security Hotspots:** мінімізовано (використання `SecureRandom` для генерації номерів рахунків)
