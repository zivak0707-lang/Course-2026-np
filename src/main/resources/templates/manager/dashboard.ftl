...
<head>
    ...
    <title>Manager Dashboard — PayFlow</title>
    ...
    <style>
        *{box-sizing:border-box}
        ...
        /* Sidebar — teal (contrasts with admin's indigo #1e1b4b) */
        ...
        .bdg-teal{background:#d1fae5;color:#065f46}
        ...
        .progress-fill{height:100%;border-radius:3px;background:linear-gradient(90deg,#059669,#10b981);transition:width .6s ease}
        ...
        .readonly-banner{background:linear-gradient(135deg,#ecfdf5,#d1fae5);border:1px solid #6ee7b7;border-radius:12px;padding:12px 18px;margin-bottom:24px;display:flex;align-items:center;gap:12px}
        .readonly-banner i{font-size:1.1rem;color:#059669}
    </style>
</head>
<body>
...
<aside class="mgr-sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="/manager/dashboard" class="nav-link active"><i class="bi bi-grid"></i> Dashboard</a>
...
<div class="mgr-main">
    <div class="topbar">
        <h5><i class="bi bi-grid me-2" style="color:#059669"></i>Manager Dashboard</h5>
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                <div style="font-size:.85rem;font-weight:600;color:#111827">
                    <#if manager??>${manager.firstName} ${manager.lastName}<#else>Manager</#if>
                </div>
    ...
    <div class="content-area">
        ...
        <div class="readonly-banner">
            <i class="bi bi-eye"></i>
            <span style="font-size:.85rem;color:#065f46">
                <strong>View-only mode.</strong> You can monitor system statistics and transactions. Contact an administrator for any changes.
            </span>
        </div>

        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h4 class="section-title mb-1">System Overview</h4>
                <p class="text-muted small mb-0">Real-time metrics from the database</p>
            </div>
            <span class="bdg bdg-teal px-3 py-2" style="font-size:.78rem">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="stat-icon" style="background:#d1fae5"><i class="bi bi-people-fill" style="color:#059669"></i></div>
                ...
                <div class="stat-card" style="<#if (pendingApprovals > 0)>border-color:#fcd34d;</#if>">
                    <div class="d-flex align-items-start justify-content-between">
                        ...
                        <#if (pendingApprovals > 0)>
                            <span class="bdg bdg-pending" style="font-size:.65rem">Pending</span>
                        <#else>
                    ...
                    <div class="stat-sub"><#if (pendingApprovals == 0)>No action required<#else>Awaiting admin review</#if></div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="stat-icon" style="background:#d1fae5"><i class="bi bi-graph-up-arrow" style="color:#059669"></i></div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-lg-8">
                <div class="panel" style="height:100%">
                    <div class="panel-header">
                        <h6><i class="bi bi-graph-up me-2" style="color:#059669"></i>Transaction Volume — Last 6 Months</h6>
            ...
            <div class="col-lg-4">
                <div class="panel" style="height:100%">
                    <div class="panel-header">
                        <h6><i class="bi bi-pie-chart me-2" style="color:#059669"></i>Status Distribution</h6>
                    </div>
                    <div class="panel-body">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                <div class="panel">
                    <div class="panel-header">
                        <h6><i class="bi bi-clock-history me-2" style="color:#059669"></i>Recent Transactions</h6>
                        <a href="/manager/transactions" class="bdg bdg-transfer px-3 py-2" style="text-decoration:none;font-size:.75rem">
...
new Chart(document.getElementById('volumeChart'),{
    ...
    data:{
        labels:volumeLabels,
        datasets:[{label:'Transactions',data:volumeData,borderColor:'#059669',backgroundColor:'rgba(5,150,105,.07)',borderWidth:2.5,pointBackgroundColor:'#059669',pointBorderColor:'#fff',pointBorderWidth:2,pointRadius:5,pointHoverRadius:7,tension:0.35,fill:true}]
    },
    options:{responsive:true,plugins:{legend:{display:false},tooltip:{backgroundColor:'#064e3b',padding:10,callbacks:{label:ctx=>'  '+ctx.parsed.y+' transaction'+(ctx.parsed.y!==1?'s':'')}}},scales:{x:{grid:{display:false},ticks:{font:{size:11},color:'#9ca3af'}},y:{beginAtZero:true,ticks:{font:{size:11},color:'#9ca3af',stepSize:1,precision:0},grid:{color:'#f3f4f6'}}}}
});
...
new Chart(document.getElementById('statusChart'),{
    ...
    options:{cutout:'70%',responsive:false,plugins:{legend:{display:false},tooltip:{backgroundColor:'#064e3b',callbacks:{label:ctx=>'  '+ctx.label+': '+ctx.parsed}}}}
});
</script>
</body>
</html>
