...
<head>
    ...
    <title>Manager Login — PayFlow</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .form-control:focus {
            border-color: #059669; box-shadow: 0 0 0 3px rgba(5,150,105,.15);
        }
        .input-group-text {
        ...
        .input-group:focus-within .input-group-text { border-color: #059669; }
        .btn-login {
            background: linear-gradient(135deg, #059669, #10b981);
        ...
        .back-link a { color: #059669; text-decoration: none; font-weight: 500; }
...
<div class="login-card">
    <div class="text-center mb-4">
        ...
        <h4 class="fw-bold mb-1" style="color:#064e3b">Manager Panel</h4>
        <p class="text-muted small mb-0">Sign in with your manager credentials</p>
    </div>
    ...
    <form method="post" action="/manager/login" autocomplete="on">
        <div class="mb-3">
            <label class="form-label" for="email">Email address</label>
            <div class="input-group">
                <span class="input-group-text"><i class="bi bi-envelope"></i></span>
                <input type="email" id="email" name="email" class="form-control"
                       placeholder="manager@company.com" required autofocus
        ...
        <button type="submit" class="btn btn-login mb-3">
            <i class="bi bi-box-arrow-in-right me-2"></i>Sign in to Manager Panel
        </button>
    </form>
